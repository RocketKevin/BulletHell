export class Shop {
    constructor(scene, texture) {
        this.array = [];
        this.shopbag = scene.add.image(window.innerWidth - 105 - 310, 437, texture).setScrollFactor(0);
        ...
        this.shopContainer.setInteractive(new Phaser.Geom.Rectangle(window.innerWidth - 105 - 310 - (this.shopbag.width / 2), 437 - (this.shopbag.height / 2), this.shopbag.width, this.shopbag.height), Phaser.Geom.Rectangle.Contains);
